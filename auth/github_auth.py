...
def get_redirect_uri() -> str:
    """
    Explicit redirect URI for GitHub OAuth.

    Set GITHUB_REDIRECT_URI in your environment / Streamlit Cloud secrets:
      - Local: http://localhost:8501/
      - Prod:  https://repomind1.streamlit.app/
    """
    return os.getenv("GITHUB_REDIRECT_URI", "http://localhost:8501/")
